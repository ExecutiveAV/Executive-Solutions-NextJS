...
import { newEntry, newEntryValidation, newEntryCompany, newEntryVenue, newEntryContractor, newEntryPosition,  newEntryPayable } from "../../types/types";
...
export const newEntryPayableSelector = createSelector(
    newEntrySelector,
    (newEntry:newEntry) => newEntry.payable
);
...
export const newEntryPayableNameSelector = createSelector(
    newEntryPayableSelector,
    (payable:newEntryPayable) => payable.payableName
);
