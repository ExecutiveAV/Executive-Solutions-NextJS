import { Invoice, InvoiceBodyContractor, InvoiceBodyContractorDay } from "../../types/types";
...
export const invoiceDataSelector = createSelector(
    invoiceSelector,
    (invoice:Invoice) => invoice.invoiceData
);

export const invoiceCurrentSelector = createSelector(
    invoiceSelector,
    (invoice:Invoice) => invoice.invoiceCurrent
);
