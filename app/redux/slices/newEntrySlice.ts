...
import { newEntry, newEntryCompany, newEntryContractor, newEntryPosition, newEntryVenue } from "../../types/types";
...
export const {
    setNewEntryKind, setNewEntryCompany, setNewEntryVenue, setNewEntryContractor, setNewEntryPosition, setNewEntryCompanyName, setNewEntryCompanyAddress, setNewEntryCompanyAddress2, setNewEntryCompanyCity, setNewEntryCompanyState, setNewEntryCompanyZip, setNewEntryCompanyPOC, setNewEntryCompanyEmail, setNewEntryCompanyPhone, setNewEntryVenueName, setNewEntryVenueAddress, setNewEntryVenueAddress2, setNewEntryVenueCity, setNewEntryVenueState, setNewEntryVenueZip, setNewEntryContractorName, setNewEntryContractorAddress, setNewEntryContractorAddress2, setNewEntryContractorCity, setNewEntryContractorState, setNewEntryContractorZip, setNewEntryContractorEmail, setNewEntryContractorPhone, setNewEntryPositionName, setNewEntryPositionRate, resetNewEntryCompany, resetNewEntryVenue, resetNewEntryContractor, resetNewEntryPosition, checkNewEntryCompanyValidation, checkNewEntryVenueValidation, checkNewEntryContractorValidation, checkNewEntryPositionValidation
